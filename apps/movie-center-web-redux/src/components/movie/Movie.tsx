                    ...
                    <div className="movie-menu-panel">
                        <div className="movie-menu-links">
                            <button
                                ...
                                onClick={() => setActiveInfoPanel(INFO_PANEL_GENERAL)}>Generell information
                            </button>
                            <button
                                className={'movie-menu-link-box ' + (activeInfoPanel === INFO_PANEL_CAST ? 'active' : '')}
                                onClick={() => setActiveInfoPanel(INFO_PANEL_CAST)}>Rollbesättning
                            </button>
                            <button
                                className={'movie-menu-link-box ' + (activeInfoPanel === INFO_PANEL_CREW ? 'active' : '')}
                                onClick={() => setActiveInfoPanel(INFO_PANEL_CREW)}>Filmteam
                            </button>
                            <button
                                className={'movie-menu-link-box ' + (activeInfoPanel === INFO_PANEL_FORMAT ? 'active' : '')}
                                onClick={() => setActiveInfoPanel(INFO_PANEL_FORMAT)}>Media & Format
                            </button>
                            <button
                                className={'movie-menu-link-box ' + (activeInfoPanel === INFO_PANEL_COVER ? 'active' : '')}
                                onClick={() => setActiveInfoPanel(INFO_PANEL_COVER)}>Omslagsbilder
                            </button>
                            <button
                                className={'movie-menu-link-box ' + (activeInfoPanel === INFO_PANEL_PERSONAL ? 'active' : '')}
                                onClick={() => setActiveInfoPanel(INFO_PANEL_PERSONAL)}>Personlig information
                            </button>
                        </div>
                    </div>
