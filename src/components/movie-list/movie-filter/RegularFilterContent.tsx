...
import {clearMovieActionState, updateFilter} from "../../../actions/movie.actions";
import {withRouter} from "react-router/modules";
import {loadFormats, loadGenres} from "../../../actions/base-data.actions";
...
const RegularFilterContent = ({
    ...
    const handleEnterKeyInvoke = (e: any, callback) => {
        if (e.key === 'Enter') {
            callback(e);
        }
    };
