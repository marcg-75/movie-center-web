module.exports = {
  ...
  'on-inverse-surface': 'rgb(var(--color-on-inverse-surface) / <alpha-value>)',
  rating: 'rgb(var(--color-rating) / <alpha-value>)',
  'on-rating': 'rgb(var(--color-on-rating) / <alpha-value>)',
  express: 'rgb(var(--color-express) / <alpha-value>)',
  'on-express': 'rgb(var(--color-on-express) / <alpha-value>)',
};
